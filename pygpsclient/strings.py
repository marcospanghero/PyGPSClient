...
PSTALLMONONZED = "CFG-MSG - Turn ON all MON msgs ZED-F9P ONLY!"
PSTALLMONONM9N = "CFG-MSG - Turn ON all MON msgs of NEO-M9N ONLY!"
PSTALLMONOFF = "CFG-MSG - Turn OFF all MON msgs"
PSTALLRXMON = "CFG-MSG - Turn ON all RXM msgs"
PSTALLRXMONZED = "CFG-MSG - Turn ON all RXM msgs ZED-F9P ONLY!"
PSTALLRXMONM9N = "CFG-MSG - Turn ON all RXM msgs of NEO-M9N ONLY!"
